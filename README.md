...
* [My Little Query](https://github.com/Cheong43/MyLittleQuery) 📊 -  A database server project written on native Java. It contain a Recursive Fescent Parser to parse the SQL-like language, detect datatype and store in build-in datatype system, generating AST to fully functional recursive Interpreter, with designed data container, and R/W local data with java IO.
